...
users = User.create!(
  [
    ...
    {email: 'ito.chika@test.com', username: '伊藤千晴', password: 'password', location: "神奈川県横浜市青葉区", introduction: "横浜で暮らす伊藤千夏です。毎週、地元のジムに通って筋トレをしています。よろしくお願いします。", profile_picture: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/test_image2.png"), filename:"test_image7.png")},
